...
export function authMiddleware(req, res, next) {
  ...
  // TODO: Fase 2 — Verificar token con Firebase Admin SDK
  // import { getAuth } from 'firebase-admin/auth';
  // const decoded = await getAuth().verifyIdToken(token);
  // req.user = decoded;

  // Por ahora, decodificar el payload del JWT sin verificación criptográfica
  // Esto es temporal — en producción DEBE usarse Firebase Admin SDK
  try {
