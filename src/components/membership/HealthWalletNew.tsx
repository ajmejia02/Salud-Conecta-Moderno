  ...
  const bonuses = useMemo(
    () => [
      ...
      },
      {
        ...
        sub: `${completedChallengesCount}/5 completado hoy`,
        pts: completedChallengesCount > 0 ? `+${completedChallengesCount * 30} pts` : '+30 pts',
        icon: CheckCircle2,
        color: 'text-primary'
      },
      {
    ...
    [isVitalCompleted, completedChallengesCount]
  );
